...
if [ $# -le 1 ]; then
     echo "usage : gst-alpr-filesrc.sh <num_streams> <stream0_mp4_file_path> <stream1_mp4_file_path>"
     exit 1
fi
if [ $1 -gt 2 ]; then
